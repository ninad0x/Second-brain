...
export function Card({title, link, type}: CardProps) {
    return <div className="cursor-pointer min-w-72 bg-white rounded-xl border border-gray-200 p-4 max-w-96">
        ...
        <div>
            {type === "youtube"
                ? <iframe className="w-full p-2 pt-8" src={link} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
